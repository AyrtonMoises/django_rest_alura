...
class MatriculaViewSet(viewsets.ModelViewSet):
    ...
    @method_decorator(cache_page(20)) #cria cache do recurso, apos cadastrar a matricula, e chamar recurso novamente, apos 20 segundos que ira aparececer a nova matricula
